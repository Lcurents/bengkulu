...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="srcmakanan/makanan.css" />
      ...
      <div class="container-fluid fw-medium teksnav">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto text-center">
            ...
            <li class="nav-item">
              <button id="teksnav">
                <a class="nav-link" href="../Wisata/index.php">Wisata</a>
              </button>
            </li>
            <li class="nav-item">
              <button id="teksnav">
                <a class="nav-link active" href="../Makanan/index.php">Kuliner</a>
              </button>
            </li>
            <li class="nav-item">
              <button id="teksnav">
        ...
        <div class="row justify-content-center">
          <div class="col hiddencenter">
            <div class="fw-bold poppinsboldsejarah" style="color: #383b38">
              <font color="#383b38"> Makanan Khas</font> <br />
              "Bengkulu"
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4 mb-4">
            <div class="card align-content-center">
              <img src="srcmakanan/image 1.png" class="card-img-top" alt="makanan" />
              <div class="card-body">
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="srcmakanan/ikan pais.png" height="237px" style="border-radius: 10px" class="card-img-top" alt="makanan" />
              <div class="card-body">
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <img src="srcmakanan/bolu koja.jpg" height="237px" style="border-radius: 10px" class="card-img-top" alt="makanan" />
              <div class="card-body">
          ...
          <div class="col-md-4 mb-4">
            <div class="card align-content-center">
              <img src="srcmakanan/lemang tapai.jpg" height="237px" style="border-radius: 10px" class="card-img-top" alt="makanan" />
              <div class="card-body">
          ...
          <div class="col-md-4 mb-4">
            <div class="card align-content-center">
              <img src="srcmakanan/lempuk durian.jpg" height="237px" style="border-radius: 10px" class="card-img-top" alt="makanan" />
              <div class="card-body">
          ...
          <div class="col-md-4 mb-4">
            <div class="card align-content-center">
              <img src="srcmakanan/bagar hiu.jpg" height="237px" style="border-radius: 10px" class="card-img-top" alt="makanan" />
              <div class="card-body">
