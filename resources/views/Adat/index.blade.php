  ...
  <body>
      ...
      <div class="container-fluid fw-medium teksnav">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto text-center">
            ...
            <li class="nav-item">
              <button id="teksnav">
                <a class="nav-link active" href="../Adat/index.php">Kearifan Lokal</a>
              </button>
            </li>
          </ul>
        </div>
    ...
    <div class="container text-center">
      <div class="row justify-content-center hiddencenter">
        <div class="col fw-bold poppinsbold" style="color: #383b38">Rumah Adat Bengkulu</div>
      </div>
    </div>
    ...
    <section>
      <div class="container text-center">
        <h1 class="text-center">
          <div class="row justify-content-center hiddencenter">
            <div class="fw-bold poppinsbold" style="color: #383b38">Baju Adat Bengkulu</div>
          </div>
        </h1>
    ...
    <div class="container text-center">
      <div class="row justify-content-center hiddencenter">
        <div class="col fw-bold poppinsbold" style="color: #383b38">Aksara KA GA NGA</div>
      </div>
    </div>
    ...
    <section>
      <div class="container text-center">
        <h1 class="text-center">
          <div class="row justify-content-center hiddencenter">
            <div class="fw-bold poppinsbold" style="color: #383b38">Lagu Daerah Bengkulu</div>
          </div>
        </h1>
      </div>
      <br /><br />
      ...
      <div class="container">
        <div class="poppinsmedium" align="left" style="color: #fff; font-size: 15px">
          <a href="https://www.instagram.com/pemprov_bengkulu/">
            <img src="../Home/Bengkulu.png" alt="Logo Sponsor" class="img-sponsor" style="float: right; margin-right: 5px" />
          </a>

          <a href="https://www.instagram.com/ukmc.palembang/">
            <img src="../Home/ukmc.png" alt="Logo Sponsor2" class="img-sponsor2" style="float: right; margin-right: 5px" />
          </a>
