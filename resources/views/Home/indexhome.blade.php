...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="srchome/style.css" />
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@500;700&display=swap" rel="stylesheet" />
    <script defer src="srchome/script.js"></script>
    <link rel="icon" href="/Home/logo atas.png" />
  </head>
  <body>
    <!-- Navbar -->
      ...
      <div class="container-fluid fw-medium teksnav">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto text-center">
            ...
            <li class="nav-item">
              <button id="teksnav">
                <a class="nav-link" href="/Makanan">Kuliner</a>
              </button>
            </li>
            <li class="nav-item">
              <button id="teksnav">
                <a class="nav-link" href="/Adat">Kearifan Lokal</a>
              </button>
            </li>
          </ul>
        </div>
    ...
    <section>
      <div class="container">
        ...
        <div class="row">
          <!-- Foto Fatmawati -->
          <div class="col-md-6">
            <img width="100%" src="srchome/—Pngtree—fatmawati monument bengkulu city icon_6846775.png" alt="fatmawati" />
          </div>
          <!-- Deskripsi Profil -->
        ...
        <div class="row">
          <!-- Foto Benteng -->
          <div class="col-md-6">
            <img src="srchome/fort-marlborough-historic-building-bengkulu-area-heritage-building-british-indonesian-monument-benteng-258924112-removebg-preview.png" alt="malborough" width="100%" />
          </div>
          <!-- Deskripsi Sejarah -->
    ...
    <section id="wisata">
      <div class="container" style="display: grid; place-items: center">
        ...
        <div style="display: flex; justify-content: center; padding-top: 3rem">
          <img src="srchome/Jumbotron.png" alt="rafles" width="100%" style="border-radius: 10px" />
        </div>
        <div class="row">
    ...
    <section id="kuliner">
      <div class="container" style="display: grid; place-items: center">
        ...
        <div style="display: flex; justify-content: center; padding-top: 3rem"><img src="srchome/ikanpais.png " alt="rafles" width="100%" style="border-radius: 10px" /></div>
        <div class="row">
          <p class="poppinsmedium" style="font-size: 25px; padding-top: 3rem; color: #0f172a" align="justify">
    ...
    <section>
      <div class="container justify-content-center">
        ...
        <div class="row text-center text-md-start pt-5">
          <!-- Foto Dika -->
          <div class="col-lg-4">
            <img src="srchome/IMG_9805.jpg" class="rounded-circle fotoprofil" alt="dika" />
          </div>
          ...
          <div class="col-lg-8 pt-5 hiddencenter">
            <button id="namecard">
              ...
              <a align="left" class="poppinsmedium" href="https://www.laurentiusdika.my.id/" style="color: #383b38; font-size: 15px">Portfolio</a>
            </button>
          </div>
        </div>
        <br />
        <div class="row text-center text-md-start pt-5">
          <!-- Foto Galih -->
          <div class="col-lg-4">
            <img src="srchome/Galih.png" class="fotoprofil" alt="galih" />
          </div>
          <div class="col-lg-8 pt-5 hiddencenter">
            <!-- Deskripsi Galih -->
            <button id="namecard">
              ...
              <a align="left" class="poppinsmedium" href="https://patrik-galih-adi-prananda.vercel.app/" style="color: #383b38; font-size: 15px">Portfolio</a>
            </button>
          </div>
        </div>
        <div class="row text-center text-md-start pt-5">
          <!-- Foto David -->
          <div class="col-lg-4">
            <img src="srchome/IMG_9829 1.png" class="rounded-circle fotoprofil" alt="david" />
          </div>
          <div class="col-lg-8 pt-5 hiddencenter">
            <!-- Deskripsi David -->
            <button id="namecard">
              ...
              <p align="left" class="poppinsmedium" style="color: #383b38; font-size: 20px">Mahasiswa Universitas Katolik Musi Charitas</p>
              <p align="left" class="poppinsmedium" style="color: #383b38; font-size: 15px">Anggota Kelompok Project Web dalam tugas Pemrograman Basis Web 1</p>
              <a align="left" class="poppinsmedium" href="https://david-gultom-portofolio-web.vercel.app" style="color: #383b38; font-size: 15px">Portfolio</a>
            </button>
          </div>
        </div>
      </div>
